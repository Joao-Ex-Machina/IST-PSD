...
synth_design -top circuito_tb -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef circuito_tb.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file circuito_tb_utilization_synth.rpt -pb circuito_tb_utilization_synth.pb"
