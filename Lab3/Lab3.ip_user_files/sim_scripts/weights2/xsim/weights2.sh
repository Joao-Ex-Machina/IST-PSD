...
#
# Script generated by Vivado on Fri Oct 27 15:35:28 WEST 2023
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot weights2 xil_defaultlib.weights2 xil_defaultlib.glbl -log elaborate.log
}
