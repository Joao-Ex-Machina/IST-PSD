...
#
# Script generated by Vivado on Sat Oct 28 14:35:36 WEST 2023
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : middle_memory.sh
...
#
# Usage        : middle_memory.sh
#                middle_memory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                middle_memory.sh [-reset_run]
#                middle_memory.sh [-reset_log]
#                middle_memory.sh [-help]
#
...
#                script (type 'middle_memory.sh -help' for more information).
#
...
# script info
echo -e "middle_memory.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./middle_memory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.middle_memory xil_defaultlib.glbl -o middle_memory_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./middle_memory_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jcr/IST/MEng/PSD/Projects/Lab3/project_1.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key middle_memory_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc middle_memory_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./middle_memory.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: middle_memory.sh [-help]\n\
Usage: middle_memory.sh [-step]\n\
Usage: middle_memory.sh [-lib_map_path]\n\
Usage: middle_memory.sh [-reset_run]\n\
Usage: middle_memory.sh [-reset_log]\n\
Usage: middle_memory.sh [-keep_index]\n\
Usage: middle_memory.sh [-noclean_files]\n\n\
